...
Compile{.keyword}: create, fix, patch, and stitch

<span class="keyword">Exploit</span>: attack, harm, force, and destroy

<span class="keyword">Ghost</span>: deceive, avoid, trick, and bypass

<span class="keyword">Network</span>: consort, comfort, convince, and empathize
